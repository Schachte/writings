    ...
    return (
        <div className={styles["hero"]}>
            ...
            <div className={styles["hero__welcome-text"]}>
                ...
                <span className={styles["hero__summary"]}>This is my blog, where I like to share things I&apos;ve <span className={`${styles["hero__link"]} ${styles["hero__linkyellow"]}`}><Link href="https://www.github.com/schachte"><a target="_blank">learned or developed</a></Link></span> 
                with the broader internet community. Wanna chat? Drop me a message from my social above.</span>
