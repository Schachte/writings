...
export default function Footer({ children }) {
  return (
    <div className={styles["footer"]}>
      ...
      <span style={{marginTop: '15px', fontFamily: 'Courier New', fontWeight: 300, color: 'limegreen'}}>If you want to contact me, use the email information found in the OpenPGP public keyblock</span>
